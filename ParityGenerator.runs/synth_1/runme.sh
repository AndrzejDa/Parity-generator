...
HD_PWD='D:/XilinxProjekty/ParityGenerator/ParityGenerator.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ParityGenerator.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ParityGenerator.tcl
