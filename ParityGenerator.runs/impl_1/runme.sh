...
HD_PWD='D:/XilinxProjekty/ParityGenerator/ParityGenerator.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ParityGenerator.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ParityGenerator.tcl -notrace
